  ...
  topics: [
    {
      ...
      lessonSections: [
        {
          sectionTitle: "What is Electric Charge?",
          sectionContentHtml: `
            <h2>Charge &amp; Units</h2>
          ...
          `,
          guidanceSentence: "Write what electric charge is and why it matters in circuits."
        },
        {
          ...
          `,
          guidanceSentence: "Note the charge symbol and the unit (coulomb)."
        },
        {
          sectionTitle: "The Electron Charge",
          sectionContentHtml: `
          ...
          `,
          guidanceSentence: "Write down the elementary charge value and what it means."
        },
        {
          sectionTitle: "SI Prefixes (Making Big Numbers Manageable)",
          sectionContentHtml: `
          ...
          `,
          guidanceSentence: "Note how prefixes change the size of a coulomb (p, n, μ, m, k, M, G)."
        },
        {
          sectionTitle: "Charge Conservation",
          sectionContentHtml: `
          ...
          `,
          guidanceSentence: "Remember charge is conserved: in equals out in a circuit."
        },
        {
          sectionTitle: "Conductors vs Insulators",
          sectionContentHtml: `
          ...
          `,
          guidanceSentence: "Note the difference between conductors and insulators and one example of each."
        }
      ]
    },
    {
      ...
      lessonSections: [
        {
          sectionTitle: "What Are Voltage and Current?",
          sectionContentHtml: `
          ...
          `,
          guidanceSentence: "Write the simple idea: current is flow and voltage is push."
        },
        {
          sectionTitle: "Current: The Flow of Charge",
          sectionContentHtml: `
          ...
          `,
          guidanceSentence: "Note the current symbol, unit (amp), and what 1 A means."
        },
        {
          sectionTitle: "Voltage: The Electric Potential Difference",
          sectionContentHtml: `
          ...
          `,
          guidanceSentence: "Note what a volt means (energy per charge) and the 12V example."
        },
        {
          sectionTitle: "Conventional Current Direction",
          sectionContentHtml: `
          ...
          `,
          guidanceSentence: "Remember conventional current is defined from positive to negative."
        },
        {
          sectionTitle: "Passive Sign Convention",
          sectionContentHtml: `
          ...
          `,
          guidanceSentence: "Note the sign rule: current enters + terminal and voltage is measured − to +."
        }
      ]
    },
    {
      ...
      lessonSections: [
        {
          sectionTitle: "What Are Power and Energy?",
          sectionContentHtml: `
            <h2>Power &amp; Energy</h2>
          ...
          `,
          guidanceSentence: "Write the difference: energy is total work and power is the rate."
        },
        {
          sectionTitle: "Instantaneous Power: The Rate of Energy Transfer",
          sectionContentHtml: `
          ...
          `,
          guidanceSentence: "Note the power unit (watt) and that power equals voltage times current."
        },
        {
          sectionTitle: "Energy: The Integral of Power Over Time",
          sectionContentHtml: `
          ...
          `,
          guidanceSentence: "Note energy is power over time and the example calculation idea."
        },
        {
          sectionTitle: "Power Absorbed vs Power Delivered",
          sectionContentHtml: `
          ...
          `,
          guidanceSentence: "Remember the sign tells if a component absorbs or supplies energy."
        },
        {
          sectionTitle: "Energy Storage in Reactive Components",
          sectionContentHtml: `
          ...
          `,
          guidanceSentence: "Note capacitors store energy with voltage and inductors store energy with current."
        },
        {
          sectionTitle: "Quick Analogy (Gaming Style)",
          sectionContentHtml: `
          ...
          `,
          guidanceSentence: "Use the gaming analogy to remember energy vs power and capacitor vs inductor."
        }
      ]
    }
  ],
